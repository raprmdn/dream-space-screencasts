...
export default function Index() {
    ...
    return (
        <>
            ...
            <SubHeader>
                <h2 className="text-white font-weight-bold my-2 mr-5">User Lists</h2>
                <div className="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <span className="label label-dot label-sm bg-white opacity-75 mx-3" />
                    <Link href={route('users.index')} className="text-white text-hover-white opacity-75 hover-opacity-100">Users</Link>
                </div>
            </SubHeader>
