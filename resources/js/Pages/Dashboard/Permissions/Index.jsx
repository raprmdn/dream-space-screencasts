...
export default function Index(props) {
    ...
    return (
        <>
                                            ...
                                            permissions.map((permission, index) => (
                                                <tr key={permission.id}>
                                                    ...
                                                    <td className="pr-0 text-right">
                                                        <a href="#" className="btn btn-icon btn-sm btn-light btn-hover-primary">
                                                    <span className="svg-icon svg-icon-3">
                                                        ...
                                                        <a href="#" className="btn btn-icon btn-sm btn-light btn-hover-danger mr-2 mx-3">
                                                    <span className="svg-icon svg-icon-3">
                                                      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                          <rect x={0} y={0} width={24} height={24} />
            ...
            <div className="modal fade" id="modalPermissions" data-backdrop="static" tabIndex="-1" role="dialog"
                 aria-labelledby="staticBackdrop" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h3 className="font-weight-boldest mt-2" id="modalTitle">Add a Permissions</h3>
                        ...
                        <div className="modal-body">
                            <form onSubmit={submitHandler} className="form">
                                <div className="form-group">
                                    ...
                                    <input type="text" id="permission_name" name="permission_name" className="form-control form-control-solid" placeholder="Enter a permission name" />
                                </div>
                                <div className="form-group">
                                    ...
                                    <input type="text" id="guard_name" name="guard_name" className="form-control form-control-solid" placeholder="Enter guard name" />
                                </div>
                                <div className="text-center">
                                    <button type="button" data-dismiss="modal"
                                            aria-label="Close" className="btn btn-light mr-3 font-weight-bold">Discard
                                    </button>
                                    <button type="submit" className="btn btn-primary font-weight-bold"> Submit
                                    </button>
                                </div>
                            </form>
                        </div>
