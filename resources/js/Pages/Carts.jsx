...
export default function Carts() {
    ...
    return (
        <>
            ...
            <Modal trigger={"selectPayment"} title={"Select Payment Type"} size={"modal-lg"}>
                    ...
                    <div className="accordion accordion-solid accordion-panel accordion-svg-toggle" id="paymentSelection">
                        <div className="card shadow shadow-sm">
                            <div className="card-header" id="headingThree8">
                                <div className="card-title collapsed" data-toggle="collapse" data-target="#manual-transfer">
                                    <div className="d-flex flex-column card-label">
                                        Manual Transfer
                                        <small className="text-muted">Pembayaran transfer secara manual, upload bukti pembayaran jika diperlukan.</small>
                                    </div>
                            ...
                            <div id="manual-transfer" className="collapse" data-parent="#paymentSelection">
                                <div className="card-body">
                                    {/*<label className="option m-0 p-3 mb-3 d-flex align-items-center">*/}
                                    {/*    <div className="symbol symbol-35 mr-5">*/}
                                    {/*        <div className="symbol-label" style={{backgroundImage: 'url("/assets/media/users/100_1.jpg")'}}/>*/}
                                    {/*    </div>*/}
                                    {/*    <span className="option-label">*/}
                                    {/*        <span className="option-head font-weight-bold">*/}
                                    {/*            Go-Pay*/}
                                    {/*        </span>*/}
                                    {/*    </span>*/}
                                    {/*    <span className="option-control">*/}
                                    {/*      <span className="radio">*/}
                                    {/*        <input type="radio" name="payment_channel" id="payment_channel" />*/}
                                    {/*        <span />*/}
                                    {/*      </span>*/}
                                    {/*    </span>*/}
                                    {/*</label>*/}
                        ...
                        <div className="card shadow shadow-sm">
                            <div className="card-header" id="headingThree8">
                                <div className="card-title collapsed" data-toggle="collapse" data-target="#instant-payment">
                                    <div className="d-flex flex-column card-label">
                                        Instant Payment
                                        <small className="text-muted">Verifikasi pembayaran secara otomatis, tanpa perlu upload bukti pembayaran.</small>
                                        {/*<small className="text-danger">Metode pembayaran ini sedang tidak dapat digunakan, silahkan gunakan metode pembayaran yang lain.</small>*/}
                                    </div>
                                    <span className="svg-icon">
                                      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                            ...
                            <div id="instant-payment" className="collapse" data-parent="#paymentSelection">
                                <div className="card-body">
                                </div>
                            </div>
                        </div>
