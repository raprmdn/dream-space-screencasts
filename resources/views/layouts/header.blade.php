<div class="bgi-no-repeat" style="background-color: #13263c;">
    <div id="kt_header" class="header header-fixed">
        <div class="container d-flex align-items-stretch justify-content-between">
            ...
            <div class="topbar">
                    ...
                    <div class="dropdown">
                        <div class="topbar-item">
                            <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
                                ...
                                <span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">{{ Str::of(Auth::user()->name)->before(' ') }}</span>
                                <span class="symbol symbol-35">
                                    <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">{{ Str::substr(Auth::user()->name, 0, 1) }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="topbar-item">
                        <a href="{{ route('login') }}" class="btn btn-flex btn-success font-weight-bolder d-flex">
                            Sign In
                        </a>
                    </div>
                @endauth
